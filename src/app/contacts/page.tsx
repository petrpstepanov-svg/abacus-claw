                        ...
                        <div className="max-w-4xl mx-auto">
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                              <div className="bg-white rounded-xl p-8 shadow-lg">
                                                            <h2 className="text-2xl font-bold mb-6 text-secondary">Contact Us</h2>h2>
                                                            <div className="space-y-4">
                                                                            <div className="flex items-center gap-3">
                                                                                              <div>
                                                                                                                  <p className="font-semibold text-secondary">Phone</p>p>
                                                                            ...
                                                                            <div className="flex items-center gap-3">
                                                                                              <div>
                                                                                                                  <p className="font-semibold text-secondary">Working Hours</p>p>
                                                                                                                  <p className="text-gray-600">24/7, around the clock</p>p>
                                                                                                </div>div>
                                                                            </div>div>
                                                                            <div className="flex items-center gap-3">
                                                                                              <div>
                                                                                                                  <p className="font-semibold text-secondary">City</p>p>
                                                                                                                  <p className="text-gray-600">Rostov-on-Don</p>p>
                                                                                                </div>div>
                                                                            </div>div>
                                                            </div>div>
                                              </div>div>
                                              <div className="bg-white rounded-xl p-8 shadow-lg">
                                                            <h2 className="text-2xl font-bold mb-6 text-secondary">Our Services</h2>h2>
                                                            <div className="space-y-3">
                                                                            <Link href="/evacuation" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                                                                              <span className="text-secondary font-medium">Evacuator 24/7</span>span>
                                                                            </Link>Link>
                                                                            <Link href="/autoservice" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                                                                              <span className="text-secondary font-medium">Autoservice</span>span>
                                                                            </Link>Link>
                                                                            <Link href="/accident-commissioner" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                                                                              <span className="text-secondary font-medium">Accident Commissioner</span>span>
                                                                            </Link>Link>
                                                            </div>div>
                                              </div>div>
                                  </div>div>
